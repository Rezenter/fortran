	program secTermFourth
		...
		do i=0,4
			...
			write(1,'(A, F8.6 )'),"Max Error f = " , max(0)
			...
			write(1,'(A, F8.6 )'),"Max Error second derivative(edge points excluded) = " , max(2)

			write(1,'(A, F8.6 )'),"Max Error third derivative(edge points excluded) = " , max(3)
