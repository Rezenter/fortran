	program thirdTermSecond
		...
		double precision :: params(0:8), max, tmp(0:1), abs, x(0:1), xGuess(0:1), scal
		...
		do i=0,8
			...
			write(1, '(A, f17.15, A, f19.17, A, I3.1)'), "root = ", x(0), " ; ", x(1), " iterations = ", count(0)	
			...
			write(1, '(A, f17.15, A, f19.17, A, I3.1, A, I3.1)'), "root = ", x(0), " ; ", x(1), " function iterations = ", count(0), " jacobian iterations = ", count(1)
